...
namespace NamedServices.Microsoft.Extensions.DependencyInjection {
    public static class IServiceCollectionExtensions {
        ...
        public static IServiceCollection AddNamedSingleton(this IServiceCollection serviceCollection, Type type, Enum key, object implementationInstance) {
            return AddNamed(serviceCollection, type, key, implementationInstance);
        }
        ...
        public static IServiceCollection AddNamedSingleton<TService>(this IServiceCollection serviceCollection, Enum key, TService implementationInstance) where TService : class {
            return AddNamed<TService>(serviceCollection, key, implementationInstance);
        }
        ...
        public static IServiceCollection TryAddNamedSingleton(this IServiceCollection serviceCollection, Type type, string key) {
            return TryAddNamed(serviceCollection, type, key, ServiceLifetime.Singleton);
        }

        public static IServiceCollection TryAddNamedSingleton(this IServiceCollection serviceCollection, Type type, string key, Func<IServiceProvider, object> implementationFactory) {
            return TryAddNamed(serviceCollection, type, key, implementationFactory, ServiceLifetime.Singleton);
        }

        public static IServiceCollection TryAddNamedSingleton(this IServiceCollection serviceCollection, Type type, string key, Type implementationType) {
            return TryAddNamed(serviceCollection, type, key, implementationType, ServiceLifetime.Singleton);
        }

        public static IServiceCollection TryAddNamedSingleton(this IServiceCollection serviceCollection, Type type, string key, object implementationInstance) {
            return TryAddNamed(serviceCollection, type, key, implementationInstance);
        }

        public static IServiceCollection TryAddNamedSingleton<TService>(this IServiceCollection serviceCollection, string key) where TService : class {
            return TryAddNamed<TService>(serviceCollection, key, ServiceLifetime.Singleton);
        }

        public static IServiceCollection TryAddNamedSingleton<TService>(this IServiceCollection serviceCollection, string key, Func<IServiceProvider, TService> implementationFactory) where TService : class {
            return TryAddNamed<TService>(serviceCollection, key, implementationFactory, ServiceLifetime.Singleton);
        }

        public static IServiceCollection TryAddNamedSingleton<TService>(this IServiceCollection serviceCollection, string key, TService implementationInstance) where TService : class {
            return TryAddNamed<TService>(serviceCollection, key, implementationInstance);
        }

        public static IServiceCollection TryAddNamedSingleton<TService, TImplementation>(this IServiceCollection serviceCollection, string key) where TService : class where TImplementation : class, TService {
            return TryAddNamed<TService, TImplementation>(serviceCollection, key, ServiceLifetime.Singleton);
        }

        public static IServiceCollection TryAddNamedSingleton<TService, TImplementation>(this IServiceCollection serviceCollection, string key, Func<IServiceProvider, TImplementation> implementationFactory) where TService : class where TImplementation : class, TService {
            return TryAddNamed<TService, TImplementation>(serviceCollection, key, implementationFactory, ServiceLifetime.Singleton);
        }



        public static IServiceCollection TryAddNamedSingleton(this IServiceCollection serviceCollection, Type type, Enum key) {
            return TryAddNamed(serviceCollection, type, key, ServiceLifetime.Singleton);
        }

        public static IServiceCollection TryAddNamedSingleton(this IServiceCollection serviceCollection, Type type, Enum key, Func<IServiceProvider, object> implementationFactory) {
            return TryAddNamed(serviceCollection, type, key, implementationFactory, ServiceLifetime.Singleton);
        }

        public static IServiceCollection TryAddNamedSingleton(this IServiceCollection serviceCollection, Type type, Enum key, Type implementationType) {
            return TryAddNamed(serviceCollection, type, key, implementationType, ServiceLifetime.Singleton);
        }

        public static IServiceCollection TryAddNamedSingleton(this IServiceCollection serviceCollection, Type type, Enum key, object implementationInstance) {
            return TryAddNamed(serviceCollection, type, key, implementationInstance);
        }

        public static IServiceCollection TryAddNamedSingleton<TService>(this IServiceCollection serviceCollection, Enum key) where TService : class {
            return TryAddNamed<TService>(serviceCollection, key, ServiceLifetime.Singleton);
        }

        public static IServiceCollection TryAddNamedSingleton<TService>(this IServiceCollection serviceCollection, Enum key, Func<IServiceProvider, TService> implementationFactory) where TService : class {
            return TryAddNamed<TService>(serviceCollection, key, implementationFactory, ServiceLifetime.Singleton);
        }

        public static IServiceCollection TryAddNamedSingleton<TService>(this IServiceCollection serviceCollection, Enum key, TService implementationInstance) where TService : class {
            return TryAddNamed<TService>(serviceCollection, key, implementationInstance);
        }

        public static IServiceCollection TryAddNamedSingleton<TService, TImplementation>(this IServiceCollection serviceCollection, Enum key) where TService : class where TImplementation : class, TService {
            return TryAddNamed<TService, TImplementation>(serviceCollection, key, ServiceLifetime.Singleton);
        }

        public static IServiceCollection TryAddNamedSingleton<TService, TImplementation>(this IServiceCollection serviceCollection, Enum key, Func<IServiceProvider, TImplementation> implementationFactory) where TService : class where TImplementation : class, TService {
            return TryAddNamed<TService, TImplementation>(serviceCollection, key, implementationFactory, ServiceLifetime.Singleton);
        }
        ...
        public static IServiceCollection TryAddNamedScoped(this IServiceCollection serviceCollection, Type type, string key) {
            return TryAddNamed(serviceCollection, type, key, ServiceLifetime.Scoped);
        }

        public static IServiceCollection TryAddNamedScoped(this IServiceCollection serviceCollection, Type type, string key, Func<IServiceProvider, object> implementationFactory) {
            return TryAddNamed(serviceCollection, type, key, implementationFactory, ServiceLifetime.Scoped);
        }

        public static IServiceCollection TryAddNamedScoped(this IServiceCollection serviceCollection, Type type, string key, Type implementationType) {
            return TryAddNamed(serviceCollection, type, key, implementationType, ServiceLifetime.Scoped);
        }

        public static IServiceCollection TryAddNamedScoped<TService>(this IServiceCollection serviceCollection, string key) where TService : class {
            return TryAddNamed<TService>(serviceCollection, key, ServiceLifetime.Scoped);
        }

        public static IServiceCollection TryAddNamedScoped<TService>(this IServiceCollection serviceCollection, string key, Func<IServiceProvider, TService> implementationFactory) where TService : class {
            return TryAddNamed<TService>(serviceCollection, key, implementationFactory, ServiceLifetime.Scoped);
        }

        public static IServiceCollection TryAddNamedScoped<TService, TImplementation>(this IServiceCollection serviceCollection, string key) where TService : class where TImplementation : class, TService {
            return TryAddNamed<TService, TImplementation>(serviceCollection, key, ServiceLifetime.Scoped);
        }

        public static IServiceCollection TryAddNamedScoped<TService, TImplementation>(this IServiceCollection serviceCollection, string key, Func<IServiceProvider, TImplementation> implementationFactory) where TService : class where TImplementation : class, TService {
            return TryAddNamed<TService, TImplementation>(serviceCollection, key, implementationFactory, ServiceLifetime.Scoped);
        }



        public static IServiceCollection TryAddNamedScoped(this IServiceCollection serviceCollection, Type type, Enum key) {
            return TryAddNamed(serviceCollection, type, key, ServiceLifetime.Scoped);
        }

        public static IServiceCollection TryAddNamedScoped(this IServiceCollection serviceCollection, Type type, Enum key, Func<IServiceProvider, object> implementationFactory) {
            return TryAddNamed(serviceCollection, type, key, implementationFactory, ServiceLifetime.Scoped);
        }

        public static IServiceCollection TryAddNamedScoped(this IServiceCollection serviceCollection, Type type, Enum key, Type implementationType) {
            return TryAddNamed(serviceCollection, type, key, implementationType, ServiceLifetime.Scoped);
        }

        public static IServiceCollection TryAddNamedScoped<TService>(this IServiceCollection serviceCollection, Enum key) where TService : class {
            return TryAddNamed<TService>(serviceCollection, key, ServiceLifetime.Scoped);
        }

        public static IServiceCollection TryAddNamedScoped<TService>(this IServiceCollection serviceCollection, Enum key, Func<IServiceProvider, TService> implementationFactory) where TService : class {
            return TryAddNamed<TService>(serviceCollection, key, implementationFactory, ServiceLifetime.Scoped);
        }

        public static IServiceCollection TryAddNamedScoped<TService, TImplementation>(this IServiceCollection serviceCollection, Enum key) where TService : class where TImplementation : class, TService {
            return TryAddNamed<TService, TImplementation>(serviceCollection, key, ServiceLifetime.Scoped);
        }

        public static IServiceCollection TryAddNamedScoped<TService, TImplementation>(this IServiceCollection serviceCollection, Enum key, Func<IServiceProvider, TImplementation> implementationFactory) where TService : class where TImplementation : class, TService {
            return TryAddNamed<TService, TImplementation>(serviceCollection, key, implementationFactory, ServiceLifetime.Scoped);
        }
        ...
        public static IServiceCollection TryAddNamedTransient(this IServiceCollection serviceCollection, Type type, string key) {
            return TryAddNamed(serviceCollection, type, key, ServiceLifetime.Transient);
        }

        public static IServiceCollection TryAddNamedTransient(this IServiceCollection serviceCollection, Type type, string key, Func<IServiceProvider, object> implementationFactory) {
            return TryAddNamed(serviceCollection, type, key, implementationFactory, ServiceLifetime.Transient);
        }

        public static IServiceCollection TryAddNamedTransient(this IServiceCollection serviceCollection, Type type, string key, Type implementationType) {
            return TryAddNamed(serviceCollection, type, key, implementationType, ServiceLifetime.Transient);
        }

        public static IServiceCollection TryAddNamedTransient<TService>(this IServiceCollection serviceCollection, string key) where TService : class {
            return TryAddNamed<TService>(serviceCollection, key, ServiceLifetime.Transient);
        }

        public static IServiceCollection TryAddNamedTransient<TService>(this IServiceCollection serviceCollection, string key, Func<IServiceProvider, TService> implementationFactory) where TService : class {
            return TryAddNamed<TService>(serviceCollection, key, implementationFactory, ServiceLifetime.Transient);
        }

        public static IServiceCollection TryAddNamedTransient<TService, TImplementation>(this IServiceCollection serviceCollection, string key) where TService : class where TImplementation : class, TService {
            return TryAddNamed<TService, TImplementation>(serviceCollection, key, ServiceLifetime.Transient);
        }

        public static IServiceCollection TryAddNamedTransient<TService, TImplementation>(this IServiceCollection serviceCollection, string key, Func<IServiceProvider, TImplementation> implementationFactory) where TService : class where TImplementation : class, TService {
            return TryAddNamed<TService, TImplementation>(serviceCollection, key, implementationFactory, ServiceLifetime.Transient);
        }



        public static IServiceCollection TryAddNamedTransient(this IServiceCollection serviceCollection, Type type, Enum key) {
            return TryAddNamed(serviceCollection, type, key, ServiceLifetime.Transient);
        }

        public static IServiceCollection TryAddNamedTransient(this IServiceCollection serviceCollection, Type type, Enum key, Func<IServiceProvider, object> implementationFactory) {
            return TryAddNamed(serviceCollection, type, key, implementationFactory, ServiceLifetime.Transient);
        }

        public static IServiceCollection TryAddNamedTransient(this IServiceCollection serviceCollection, Type type, Enum key, Type implementationType) {
            return TryAddNamed(serviceCollection, type, key, implementationType, ServiceLifetime.Transient);
        }

        public static IServiceCollection TryAddNamedTransient<TService>(this IServiceCollection serviceCollection, Enum key) where TService : class {
            return TryAddNamed<TService>(serviceCollection, key, ServiceLifetime.Transient);
        }

        public static IServiceCollection TryAddNamedTransient<TService>(this IServiceCollection serviceCollection, Enum key, Func<IServiceProvider, TService> implementationFactory) where TService : class {
            return TryAddNamed<TService>(serviceCollection, key, implementationFactory, ServiceLifetime.Transient);
        }

        public static IServiceCollection TryAddNamedTransient<TService, TImplementation>(this IServiceCollection serviceCollection, Enum key) where TService : class where TImplementation : class, TService {
            return TryAddNamed<TService, TImplementation>(serviceCollection, key, ServiceLifetime.Transient);
        }

        public static IServiceCollection TryAddNamedTransient<TService, TImplementation>(this IServiceCollection serviceCollection, Enum key, Func<IServiceProvider, TImplementation> implementationFactory) where TService : class where TImplementation : class, TService {
            return TryAddNamed<TService, TImplementation>(serviceCollection, key, implementationFactory, ServiceLifetime.Transient);
        }
        ...
        public static IServiceCollection TryAddNamed(this IServiceCollection serviceCollection, Type type, string key, ServiceLifetime serviceLifetime) {

            return TryAddNamed(serviceCollection, type, key, provider => ActivatorUtilities.CreateInstance(provider, type),
                serviceLifetime);
        }

        public static IServiceCollection TryAddNamed(this IServiceCollection serviceCollection, Type type, string key, Func<IServiceProvider, object> implementationFactory, ServiceLifetime serviceLifetime) {
        ...
        public static IServiceCollection TryAddNamed(this IServiceCollection serviceCollection, Type type, string key, Type implementationType, ServiceLifetime serviceLifetime) {

            return TryAddNamed(serviceCollection, type, key, provider => ActivatorUtilities.CreateInstance(provider, implementationType),
                serviceLifetime);

        }

        public static IServiceCollection TryAddNamed(this IServiceCollection serviceCollection, Type type, string key, object implementationInstance) {
        ...
        public static IServiceCollection TryAddNamed<TService>(this IServiceCollection serviceCollection, string key, ServiceLifetime serviceLifetime) where TService : class {

            return TryAddNamed(serviceCollection, typeof(TService), key, serviceLifetime);

        }

        public static IServiceCollection TryAddNamed<TService>(this IServiceCollection serviceCollection, string key, Func<IServiceProvider, TService> implementationFactory, ServiceLifetime serviceLifetime) where TService : class {

            return TryAddNamed(serviceCollection, typeof(TService), key, implementationFactory, serviceLifetime);

        }

        public static IServiceCollection TryAddNamed<TService>(this IServiceCollection serviceCollection, string key, TService implementationInstance) where TService : class {
            return TryAddNamed(serviceCollection, typeof(TService), key, implementationInstance);
        }

        public static IServiceCollection TryAddNamed<TService, TImplementation>(this IServiceCollection serviceCollection, string key, ServiceLifetime serviceLifetime) where TService : class where TImplementation : class, TService {

            return TryAddNamed(serviceCollection, typeof(TService), key, typeof(TImplementation), serviceLifetime);

        }

        public static IServiceCollection TryAddNamed<TService, TImplementation>(this IServiceCollection serviceCollection, string key, Func<IServiceProvider, TImplementation> implementationFactory, ServiceLifetime serviceLifetime) where TService : class where TImplementation : class, TService {
        ...
        public static IServiceCollection TryAddNamed(this IServiceCollection serviceCollection, Type type, Enum key, ServiceLifetime serviceLifetime) {
        ...
        public static IServiceCollection TryAddNamed(this IServiceCollection serviceCollection, Type type, Enum key, Type implementationType, ServiceLifetime serviceLifetime) {
        ...
        public static IServiceCollection TryAddNamed<TService>(this IServiceCollection serviceCollection, Enum key, ServiceLifetime serviceLifetime) where TService : class {

            return TryAddNamed(serviceCollection, typeof(TService), key, serviceLifetime);

        }

        public static IServiceCollection TryAddNamed<TService>(this IServiceCollection serviceCollection, Enum key, Func<IServiceProvider, TService> implementationFactory, ServiceLifetime serviceLifetime) where TService : class {

            return TryAddNamed(serviceCollection, typeof(TService), key, implementationFactory, serviceLifetime);

        }

        public static IServiceCollection TryAddNamed<TService>(this IServiceCollection serviceCollection, Enum key, TService implementationInstance) where TService : class {
            return TryAddNamed(serviceCollection, typeof(TService), key, implementationInstance);
        }

        public static IServiceCollection TryAddNamed<TService, TImplementation>(this IServiceCollection serviceCollection, Enum key, ServiceLifetime serviceLifetime) where TService : class where TImplementation : class, TService {

            return TryAddNamed(serviceCollection, typeof(TService), key, typeof(TImplementation), serviceLifetime);

        }

        public static IServiceCollection TryAddNamed<TService, TImplementation>(this IServiceCollection serviceCollection, Enum key, Func<IServiceProvider, TImplementation> implementationFactory, ServiceLifetime serviceLifetime) where TService : class where TImplementation : class, TService {
